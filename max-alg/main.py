...
from alg_functions import get_fitness_from_individual_maximization, get_fitness_from_individual_minimization, f, print_plot_function_with_point
...
if __name__ == "__main__":
    ...
    initial_population = create_pop_in_range(max_value=props["MAX"],
                                             ...
                                             pop_size=props["POP"])
    value = 1.8493
    initial_population.append(value)
    ...
    print_plot_function_with_point(value)